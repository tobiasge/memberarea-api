...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    private Authentication getAuthentication(HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            Long iClubUserId = JWTUtils.extractIdFromToken(token);
            IClubUser.UserType userType = JWTUtils.extractUserTypeFromToken(token);

            Optional<? extends IClubUser> optIClubUser = this.userService.findById(iClubUserId, userType);
