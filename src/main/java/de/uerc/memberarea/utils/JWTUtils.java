...
public class JWTUtils {
    ...
    public static String createToken(ClubUser clubUser) {
    ...
    public static ClubUser.UserType extractUserTypeFromToken(String token) {
        String userType = readToken(token).getHeader().getOrDefault(USER_TYPE_KEY, ClubUser.UserType.MEMBER.toString())
            .toString();
        return ClubUser.UserType.valueOf(ClubUser.UserType.class, userType);
    }
